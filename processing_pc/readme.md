...
**Note:** You can use the loader and depth cloud code on Android too. However, the amount of memory needed for displaying large point clouds is too high for use in APDE, so depthcloudpc.pde isn't really suitable for use there unless you decimate the cloud to a sensible size. But, of course, you could generate the point cloud in APDE and save it for use in other apps.
